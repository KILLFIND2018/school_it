...
<body>
    <div class="container-fluid">
        ...
        <div class="why-for-child">
            ...
            <ul>
                <li><img src="/img/icons/dollar.svg" alt="">Средняя зарплата IT-специалиста выше на 70%</li>
                <li><img src="/img/icons/browser.svg" alt="">Международный сертификат — реальный шанс на трудоустройство</li>
                <li><img src="/img/icons/talk.svg" alt="">Обучаем с элементами английского языка</li>
                <li><img src="/img/icons/brain.svg" alt="">Развиваем логику, креативность и уверенность</li>
            </ul>
        </div>
        <div class="direction">
            ...
            <div class="feedbakers">
                ...
                <p>Запишитесь на бесплатный первый урок и узнайте, подходит ли вашему ребёнку IT-путь!</p>
            </div>
        </div>
